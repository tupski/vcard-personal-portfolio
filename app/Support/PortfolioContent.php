 ...
 *
 * Phase 2 is a faithful migration of the original static template, so the
 * copy lives here as the single source of truth for the Blade views. Phase 3
 * introduces the database schema and Phase 4 replaces this class with Eloquent
 * models and a settings repository — the array shape mirrors the eventual
 * column names so the swap is mechanical.
 */
